...
#define DEBUG_UART_BAUDRATE (921600)       // 指定 debug uart 所使用的的串口波特率
#define DEBUG_UART_TX_PIN (UART3_TX_P15_6) // 指定 debug uart 所使用的的串口引脚
#define DEBUG_UART_RX_PIN (UART3_RX_P15_7) // 指定 debug uart 所使用的的串口引脚
