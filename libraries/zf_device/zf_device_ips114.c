...
static uint16                   ips114_pencolor     = IPS114_DEFAULT_PENCOLOR;          // 画笔颜色(字体色)
static uint16                   ips114_bgcolor      = IPS114_DEFAULT_BGCOLOR;           // 背景颜色
...
//-------------------------------------------------------------------------------------------------------------------
// 函数简介     IPS114 软件 SPI 写 8bit 数据数组
// 参数说明     *data           数据
// 参数说明     len             数据长度
// 返回参数     void
...
//-------------------------------------------------------------------------------------------------------------------
// 函数简介     IPS114 软件 SPI 写 16bit 数据数组
// 参数说明     *data           数据
// 参数说明     len             数据长度
// 返回参数     void
...
// 参数说明     y2              结束y轴坐标
// 返回参数     void
// 使用示例     ips114_set_region(0, 0, ips114_width_max - 1, ips114_height_max - 1);
// 备注信息     内部调用
//-------------------------------------------------------------------------------------------------------------------
...
// 参数说明     width           图像实际宽度
// 参数说明     height          图像实际高度
// 参数说明     dis_width       图像显示宽度 参数范围 [0, ips114_width_max]
// 参数说明     dis_height      图像显示高度 参数范围 [0, ips114_height_max]
// 返回参数     void
