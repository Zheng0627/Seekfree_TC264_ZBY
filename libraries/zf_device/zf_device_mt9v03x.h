...
#define MT9V03X_INIT_TIMEOUT (0x0080) // 默认的摄像头初始化超时时间 毫秒为单位0x0080
//================================================定义 MT9V03X 基本配置================================================
...
#define MT9V03X_FPS_DEF (60)       // 图像帧率         摄像头收到后会自动计算出最大FPS，如果过大则设置为计算出来的最大FPS
...
#define MT9V03X_UD_OFFSET_DEF (0)  // 图像上下偏移量   正值 上偏移   负值 下偏移  行为120 240 480时无法设置偏移
                                   //                  摄像头收偏移数据后会自动计算最大偏移，如果超出则设置计算出来的最大偏移
#define MT9V03X_GAIN_DEF (30)      // 图像增益         范围 [16-64]  增益可以在曝光时间固定的情况下改变图像亮暗程度
